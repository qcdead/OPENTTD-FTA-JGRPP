...
void Blitter_32bppBase::SetPixel(void *video, int x, int y, uint16_t colour)
{
...
void Blitter_32bppBase::DrawLine(void *video, int x, int y, int x2, int y2, int screen_width, int screen_height, uint16_t colour, int width, int dash)
{
...
void Blitter_32bppBase::DrawRect(void *video, int width, int height, uint16_t colour)
{
