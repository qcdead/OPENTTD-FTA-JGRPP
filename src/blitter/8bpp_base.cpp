...
void Blitter_8bppBase::SetPixel(void *video, int x, int y, uint16_t colour)
{
...
void Blitter_8bppBase::DrawLine(void *video, int x, int y, int x2, int y2, int screen_width, int screen_height, uint16_t colour, int width, int dash)
{
	const int screen_pitch = this->GetScreenPitch();
...
void Blitter_8bppBase::DrawRect(void *video, int width, int height, uint16_t colour)
{
	const int screen_pitch = this->GetScreenPitch();
	do {
