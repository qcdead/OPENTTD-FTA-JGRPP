...
static std::vector<NamedSaveLoad> MakeIndustryDesc()
{
	...
	output.insert(output.end(), {
		...
		NSL("owner",                               SLE_VAR(Industry, owner,                      SLE_UINT16)),
		...
		NSL("founder",                         SLE_CONDVAR(Industry, founder,                    SLE_UINT16,                        SLV_70,                          SL_MAX_VERSION)),
	...
	output.insert(output.end(), {
		...
		NSL("exclusive_supplier",              SLE_CONDVAR(Industry, exclusive_supplier,         SLE_UINT16,                        SLV_GS_INDUSTRY_CONTROL,         SL_MAX_VERSION)),
		NSL("exclusive_consumer",              SLE_CONDVAR(Industry, exclusive_consumer,         SLE_UINT16,                        SLV_GS_INDUSTRY_CONTROL,         SL_MAX_VERSION)),
