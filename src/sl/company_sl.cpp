...
static const NamedSaveLoad _company_livery_desc[] = {
	...
	NSL("colour1", SLE_CONDVAR(Livery, colour1, SLE_UINT16, SLV_34, SL_MAX_VERSION)),
	NSL("colour2", SLE_CONDVAR(Livery, colour2, SLE_UINT16, SLV_34, SL_MAX_VERSION)),
};
...
static const NamedSaveLoad _company_desc[] = {
	...
	NSL("colour",                           SLE_VAR(CompanyProperties, colour,                SLE_UINT16)),
	...
	NSL("share_owners",                     SLE_ARR(CompanyProperties, share_owners,          SLE_UINT16, 4)),
	...
	NSL("bankrupt_last_asked",        SLE_CONDVAR_X(CompanyProperties, bankrupt_last_asked,   SLE_UINT16,        SL_MIN_VERSION, SL_MAX_VERSION, SlXvFeatureTest(XSLFTO_AND, XSLFI_BANKRUPTCY_EXTRA))),
	...
	NSL("bankrupt_asked",               SLE_CONDVAR(CompanyProperties, bankrupt_asked,        SLE_UINT32,                  SLV_104, SL_MAX_VERSION)),
	...
	NSL("yearly_expenses",              SLE_CONDARR(CompanyProperties, yearly_expenses,       SLE_FILE_I64 | SLE_VAR_I64, 3 * 13, SL_MIN_VERSION, SLV_2)),
