...
NamedSaveLoadTable GetTemplateVehicleDesc() {
	static const NamedSaveLoad _template_veh_desc[] = {
		...
		NSL("owner",                   SLE_CONDVAR_X(TemplateVehicle, owner, SLE_VAR_U16 | SLE_FILE_U32, SL_MIN_VERSION, SL_MAX_VERSION, SlXvFeatureTest(XSLFTO_AND, XSLFI_TEMPLATE_REPLACEMENT, 0, 3))),
		NSL("owner",                   SLE_CONDVAR_X(TemplateVehicle, owner, SLE_UINT16, SL_MIN_VERSION, SL_MAX_VERSION, SlXvFeatureTest(XSLFTO_AND, XSLFI_TEMPLATE_REPLACEMENT, 4))),
