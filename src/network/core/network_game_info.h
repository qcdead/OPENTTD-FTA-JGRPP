...
struct NetworkServerGameInfo {
	...
	uint16_t clients_on;          ///< Current count of clients on server
	uint16_t clients_max;         ///< Max clients allowed on server
	uint16_t companies_on;        ///< How many started companies do we have
	uint16_t companies_max;       ///< Max companies allowed on server
	uint16_t spectators_on;       ///< How many spectators do we have?
